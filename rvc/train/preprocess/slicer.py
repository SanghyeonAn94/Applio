"""Slices audio waveforms into segments based on RMS silence detection.

Slicer takes sr, threshold (dB), min_length, min_interval, hop_size and max_sil_kept
(all time-based in ms) and its slice() method returns a list of waveform segments split
at detected silences.
"""
